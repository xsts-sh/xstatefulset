...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&XStatefulSet{}, func(obj interface{}) { SetObjectDefaults_XStatefulSet(obj.(*XStatefulSet)) })
	scheme.AddTypeDefaultingFunc(&XStatefulSetList{}, func(obj interface{}) { SetObjectDefaults_XStatefulSetList(obj.(*XStatefulSetList)) })
	return nil
}

func SetObjectDefaults_XStatefulSet(in *XStatefulSet) {
	SetDefaults_XStatefulSet(in)
...
func SetObjectDefaults_XStatefulSetList(in *XStatefulSetList) {
	for i := range in.Items {
		a := &in.Items[i]
		SetObjectDefaults_XStatefulSet(a)
	}
}
