...
// AppsV1Client is used to interact with features provided by the apps.x-k8s.io group.
type AppsV1Client struct {
	restClient rest.Interface
}

func (c *AppsV1Client) XStatefulSets(namespace string) XStatefulSetInterface {
	return newXStatefulSets(c, namespace)
}
